...
public:
	...
	~CGXBitmap(void);
	 ...
	 void Show(CImageDataPointer& objCImageDataPointer, POINT &pt1, POINT &pt2);
...
private:
	...
	void __DrawImg2(BYTE* pBuffer, POINT &pt1, POINT &pt2);

private:
	HWND				m_hWnd;                           ///< The pointer for display image form
...
private:
	...
	HDC m_hMemDC;
	HBITMAP m_hBitmap;
	unsigned int m_nLastWidth;
	unsigned int m_nLastHeight;
};
