		...
		*/
		...
		void DoOnImageCaptured(CImageDataPointer& objImageDataPointer, void* pUserParam)
		{
			try
			{
				...
				TRACE("收到图像数据 width: %d  height: %d size:%d buffer:%x.....\n", objImageDataPointer->GetWidth(), objImageDataPointer->GetHeight(),
					objImageDataPointer->GetPayloadSize(), objImageDataPointer->GetBuffer());
			}
